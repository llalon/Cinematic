---
description: 'Guidelines for client code for qbittorrent api'
applyTo: '**/*.java, **/*.kt'
---
...
For an additional source of WebAPI changes, see [WebAPI_Changelog.md](https://github.com/qbittorrent/qBittorrent/blob/master/WebAPI_Changelog.md).
