...
/**
 * Exception thrown when Tautulli API returns an error response.
 * This indicates remote API errors such as HTTP errors, network failures,
 * authentication failures, or rate limiting.
 */
@Getter
public class TautulliApiException extends RuntimeException {

    /** HTTP status code returned by Tautulli, or {@code null} when the request failed before a response arrived. */
    private final Integer statusCode;
    /** Raw response body returned by Tautulli, or {@code null} when no response body was available. */
     ...
     * @param statusCode HTTP status code returned by the Tautulli API
     * @param responseBody raw response body (may be empty)
     */
    public TautulliApiException(String message, int statusCode, String responseBody) {
        super(message);
     ...
     */
    public TautulliApiException(String message, Throwable cause) {
        super(message, cause);
